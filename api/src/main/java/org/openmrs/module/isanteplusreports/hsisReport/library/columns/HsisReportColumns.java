...
public class HsisReportColumns {
    ...
    public static final String HV = "homemade_visits_";
     ...
     public static void addColumsForEpisodesOfDiseases(CohortIndicatorDataSetDefinition dsd, CohortIndicator cohortIndicator) {
       ...
       constructColumn(FOOD + "f_0-1", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection|gender=F|age=0_1", dsd);
       constructColumn(FOOD + "m_0-1", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection|gender=M|age=0_1", dsd);
       constructColumn(FOOD + "f_1-4", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection|gender=F|age=1_4", dsd);
       constructColumn(FOOD + "m_1-4", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection|gender=M|age=1_4", dsd);
       constructColumn(FOOD + "f_5-9", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection|gender=F|age=5_9", dsd);
       constructColumn(FOOD + "m_5-9", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection|gender=M|age=5_9", dsd);
       constructColumn(FOOD + "f_10-14", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection|gender=F|age=10_14", dsd);
       constructColumn(FOOD + "m_10-14", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection|gender=M|age=10_14", dsd);
       constructColumn(FOOD + "f_15-19", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection|gender=F|age=15_19", dsd);
       constructColumn(FOOD + "m_15-19", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection|gender=M|age=15_19", dsd);
       constructColumn(FOOD + "f_20-24", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection|gender=F|age=20_24", dsd);
       constructColumn(FOOD + "m_20-24", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection|gender=M|age=20_24", dsd);
       constructColumn(FOOD + "f_25-49", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection|gender=F|age=25_49", dsd);
       constructColumn(FOOD + "m_25-49", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfectiongender=M|age=25_49", dsd);
       constructColumn(FOOD + "f_50+", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection|gender=F|age=50+", dsd);
       constructColumn(FOOD + "m_50+", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection|gender=M|age=50+", dsd);
       constructColumn(TOTAL_DISEASES + "food_f", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection|gender=F", dsd);
       constructColumn(TOTAL_DISEASES + "food_m", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection|gender=M", dsd);
       constructColumn(TOTAL_CASES_REF + "food", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection", dsd);
       constructColumn(DECEASED + "food", "Diseases (disaggregation by age and sex)", cohortIndicator, "diseaseComplication=collectiveFoodInfection", dsd);
